  ...
  return (
    <div >
        ...
        <form onSubmit={savePlace} >
            ...
            <input 
                type='text' 
                placeholder='Example: Golden Triangle Condo with 4 rooms and 3 beds' 
                value={title}
            ...
            <input 
                type='text' 
                placeholder='Example: City, State, Country' 
                value={address}
            ...
            <div className='grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2' >
                {addedPhotos.length > 0 && addedPhotos.map((photosLink) => (
                    <div key={photosLink} className='h-32 flex relative'>
                        <Image className='rounded-2xl cursor-pointer w-full object-cover' src={photosLink} alt="room image" />
                ...
                <label className="flex h-32 cursor-pointer items-center justify-center gap-2 border p-8 rounded-2xl font-semibold text-lg sm:text-2xl" >
